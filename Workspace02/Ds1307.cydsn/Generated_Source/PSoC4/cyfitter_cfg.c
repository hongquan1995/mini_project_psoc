...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT07), 0x00000021u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_SELECT12), 0x00000031u);
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x8000000Eu);

	/* CYDEV_CLK_DIVIDER_B01 Starting address: CYDEV_CLK_DIVIDER_B01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_B01), 0x80000017u);

	/* CYDEV_CLK_DIVIDER_C01 Starting address: CYDEV_CLK_DIVIDER_C01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C01), 0x80000138u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		static const uint8 CYCODE BS_UDB_0_1_1_CONFIG_VAL[] = {
			0x00u, 0x10u, 0xF3u, 0x00u, 0x0Fu, 0x08u, 0xF0u, 0x00u, 0x1Cu, 0x18u, 0xE3u, 0x00u, 0x08u, 0x00u, 0x00u, 0x00u, 
			0x00u, 0x7Fu, 0x00u, 0x00u, 0xC3u, 0x39u, 0x00u, 0x44u, 0xF3u, 0x00u, 0x0Cu, 0x01u, 0xFFu, 0x01u, 0x00u, 0x80u, 
			0x41u, 0x00u, 0x00u, 0x00u, 0x04u, 0x67u, 0x00u, 0x18u, 0x0Cu, 0x39u, 0x00u, 0x42u, 0x82u, 0x00u, 0x00u, 0x06u, 
			0x1Cu, 0x20u, 0x2Cu, 0x80u, 0x0Fu, 0x1Fu, 0xC0u, 0x40u, 0x00u, 0x80u, 0x28u, 0x20u, 0x00u, 0x00u, 0x00u, 0x01u, 
			0x32u, 0x05u, 0x04u, 0x00u, 0x01u, 0x00u, 0xCEu, 0x00u, 0x0Cu, 0xFFu, 0xFFu, 0xFFu, 0x62u, 0xA0u, 0xF0u, 0x41u, 
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL3), 0x0008EE37u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG4), 0x20000000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG8), 0x00530000u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x0000008Fu);
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x00C40DB6u);
	...
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x00006DB0u);
	CY_SET_REG32((void *)(CYREG_PRT3_PC2), 0x00000001u);
