// ======================================================================
// Ds1307.v generated from TopDesign.cysch
// 11/24/2020 at 14:17
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b1bc711d-2e77-4535-a648-e824a29a1699/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_SEQ_P4_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("cb3e24e5-c71e-44f2-a1d3-848a35b31bc2/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=120, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=240, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=PWM_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_2, CY_INSTANCE_SHORT_NAME=PWM_2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_2, )
...
module top ;
	...
	wire [3:0] tmpOE__Pin_Ctrl_net;
	wire [3:0] tmpFB_3__Pin_Ctrl_net;
	wire [3:0] tmpIO_3__Pin_Ctrl_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Ctrl_net;
	electrical [0:0] tmpSIOVREF__Pin_Ctrl_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_Ctrl
		 (.oe(tmpOE__Pin_Ctrl_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Pin_Ctrl_net[3:0]}),
		  .io({tmpIO_3__Pin_Ctrl_net[3:0]}),
		  .siovref(tmpSIOVREF__Pin_Ctrl_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Ctrl_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Ctrl_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

	wire [7:0] tmpOE__Pin_7Seg_net;
	wire [7:0] tmpFB_7__Pin_7Seg_net;
	wire [7:0] tmpIO_7__Pin_7Seg_net;
	wire [0:0] tmpINTERRUPT_0__Pin_7Seg_net;
	electrical [0:0] tmpSIOVREF__Pin_7Seg_net;

	cy_psoc3_pins_v1_10
		#(.id("38a9da93-aaa8-4e36-b208-f36c4c80ac9f"),
		...
		Pin_7Seg
		 (.oe(tmpOE__Pin_7Seg_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__Pin_7Seg_net[7:0]}),
		  .io({tmpIO_7__Pin_7Seg_net[7:0]}),
		  .siovref(tmpSIOVREF__Pin_7Seg_net),
		  .interrupt({tmpINTERRUPT_0__Pin_7Seg_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_7Seg_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
	...
	cy_clock_v1_0
		#(.id("3d8b3e6a-7547-4523-adfb-6473c15cebec"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__tx_uart_net;
	wire [0:0] tmpFB_0__tx_uart_net;
	wire [0:0] tmpIO_0__tx_uart_net;
	wire [0:0] tmpINTERRUPT_0__tx_uart_net;
	electrical [0:0] tmpSIOVREF__tx_uart_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		tx_uart
		 (.oe(tmpOE__tx_uart_net),
		  .y({Net_233}),
		  .fb({tmpFB_0__tx_uart_net[0:0]}),
		  .io({tmpIO_0__tx_uart_net[0:0]}),
		  .siovref(tmpSIOVREF__tx_uart_net),
		  .interrupt({tmpINTERRUPT_0__tx_uart_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__tx_uart_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__rx_uart_net;
	wire [0:0] tmpIO_0__rx_uart_net;
	wire [0:0] tmpINTERRUPT_0__rx_uart_net;
	electrical [0:0] tmpSIOVREF__rx_uart_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		rx_uart
		 (.oe(tmpOE__rx_uart_net),
		  .y({1'b0}),
		  .fb({Net_238}),
		  .io({tmpIO_0__rx_uart_net[0:0]}),
		  .siovref(tmpSIOVREF__rx_uart_net),
		  .interrupt({tmpINTERRUPT_0__rx_uart_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rx_uart_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("c3ba60ae-03a7-4b24-9556-1b6654b97634"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("83333333.3333333"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pin_pwm1_net;
	wire [0:0] tmpFB_0__Pin_pwm1_net;
	wire [0:0] tmpIO_0__Pin_pwm1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_pwm1_net;
	electrical [0:0] tmpSIOVREF__Pin_pwm1_net;

	cy_psoc3_pins_v1_10
		#(.id("ee89d9c1-a531-4d25-a07e-71f9def62b89"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_pwm1
		 (.oe(tmpOE__Pin_pwm1_net),
		  .y({Net_287}),
		  .fb({tmpFB_0__Pin_pwm1_net[0:0]}),
		  .io({tmpIO_0__Pin_pwm1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_pwm1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_pwm1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_pwm1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_6 PWM_2 (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("cc9c1571-61c1-4111-9062-9672f44bac07"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("83333333.3333333"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pin_pwm2_net;
	wire [0:0] tmpFB_0__Pin_pwm2_net;
	wire [0:0] tmpIO_0__Pin_pwm2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_pwm2_net;
	electrical [0:0] tmpSIOVREF__Pin_pwm2_net;

	cy_psoc3_pins_v1_10
		#(.id("6b6fc55a-fe39-48af-84c1-72d0c3e27809"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_pwm2
		 (.oe(tmpOE__Pin_pwm2_net),
		  .y({Net_297}),
		  .fb({tmpFB_0__Pin_pwm2_net[0:0]}),
		  .io({tmpIO_0__Pin_pwm2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_pwm2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_pwm2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_pwm2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
