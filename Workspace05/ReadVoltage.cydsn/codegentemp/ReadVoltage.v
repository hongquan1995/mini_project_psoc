// ======================================================================
// ReadVoltage.v generated from TopDesign.cysch
// 01/09/2021 at 11:22
...
module ADC_SAR_SEQ_P4_v2_50_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("e240c958-eb5d-4723-adf8-36634c2cecee/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("e240c958-eb5d-4723-adf8-36634c2cecee/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("78125000"),
		  .is_direct(0),
...
// SCB_P4_v4_0(ApplySbClockParam=false, BitWidthReplacementStringRx=uint8, BitWidthReplacementStringTx=uint8, BufNum=1, Cond=#, DBGW_SCB_IP_V0=false, DBGW_SCB_IP_V1=false, DBGW_SCB_IP_V2=true, DW_Hide_i2c=true, DW_Hide_Scbv0Feature=true, DW_Hide_Scbv2Feature=false, DW_Hide_Spi=false, DW_Hide_Uart=true, DW_Hide_UartFlowControl=true, DW_INTR_SPI_EC=GLCD_SPIM_SCB__INTR_SPI_EC, DW_INTR_SPI_EC_MASK=GLCD_SPIM_SCB__INTR_SPI_EC_MASK, DW_INTR_SPI_EC_MASKED=GLCD_SPIM_SCB__INTR_SPI_EC_MASKED, DW_SPI_CTRL=GLCD_SPIM_SCB__SPI_CTRL, DW_SPI_STATUS=GLCD_SPIM_SCB__SPI_STATUS, DW_UART_CTRL=, DW_UART_FLOW_CTRL=, DW_UART_RX_CTRL=, DW_UART_TX_CTRL=, EndCond=#endif, EzI2cBitWidthReplacementString=uint16, EzI2cBusVoltage=3.3, EzI2cByteModeEnable=false, EzI2cClkFreqDes=1550, EzI2cClockFromTerm=false, EzI2cClockStretching=true, EzI2cDataRate=100, EzI2cIsPrimarySlaveAddressHex=true, EzI2cIsSecondarySlaveAddressHex=true, EzI2cMedianFilterEnable=true, EzI2cNumberOfAddresses=0, EzI2cOvsFactor=16, EzI2cPrimarySlaveAddress=8, EzI2cSecondarySlaveAddress=9, EzI2cShowTerminals=false, EzI2cSlaveAddressMask=254, EzI2cSlewRate=0, EzI2cSubAddressSize=0, EzI2cWakeEnable=false, I2cAcceptAddress=false, I2cAcceptGeneralCall=false, I2cBusVoltage=3.3, I2cBusVoltageLevel=, I2cByteModeEnable=false, I2cClkFreqDes=1550, I2cClockFromTerm=false, I2cDataRate=100, I2cExternIntrHandler=false, I2cIsSlaveAddressHex=true, I2cIsSlaveAddressMaskHex=true, I2cManualOversampleControl=true, I2cMedianFilterEnable=true, I2cMode=1, I2cOvsFactor=16, I2cOvsFactorHigh=8, I2cOvsFactorLow=8, I2cShowTerminals=false, I2cSlaveAddress=8, I2cSlaveAddressMask=254, I2cSlewRate=0, I2cSlewRateSettings=0, I2cTermsEnable=false, I2cWakeEnable=false, PinLocationP4A=true, PinName0Unconfig=uart_rx_i2c_scl_spi_mosi, PinName0UnconfigWake=uart_rx_wake_i2c_scl_spi_mosi, PinName1Unconfig=uart_tx_i2c_sda_spi_miso, PinName2Unconfig=uart_cts_spi_sclk, PinName3Unconfig=uart_rts_spi_ss0, Pn0Unconfig=RX_SCL_MOSI, Pn0UnconfigWake=RX_WAKE_SCL_MOSI, Pn1Unconfig=TX_SDA_MISO, Pn2Unconfig=CTS_SCLK, Pn3Unconfig=RTS_SS0, RemoveI2cPins=true, RemoveMisoSdaTx=true, RemoveMosiSclRx=true, RemoveMosiSclRxWake=true, RemoveScbClk=false, RemoveScbIrq=true, RemoveSpiMasterMiso=false, RemoveSpiMasterMosi=false, RemoveSpiMasterPins=false, RemoveSpiMasterSclk=false, RemoveSpiMasterSs0Pin=true, RemoveSpiMasterSs1Pin=true, RemoveSpiMasterSs2Pin=true, RemoveSpiMasterSs3Pin=true, RemoveSpiSclk=true, RemoveSpiSlaveMiso=true, RemoveSpiSlaveMosi=true, RemoveSpiSlavePins=true, RemoveSpiSs0=true, RemoveSpiSs1=true, RemoveSpiSs2=true, RemoveSpiSs3=true, RemoveUartCtsPin=true, RemoveUartRtsPin=true, RemoveUartRxPin=true, RemoveUartRxTxPin=true, RemoveUartRxWake=true, RemoveUartRxWakeupIrq=true, RemoveUartTxPin=true, RxTriggerOutputEnable=false, ScbClkFreqDes=13000, ScbClkMinusTolerance=100, ScbClkPlusTolerance=2, ScbClockSelect=1, ScbClockTermEnable=false, ScbCustomIntrHandlerEnable=true, ScbInterruptTermEnable=false, ScbMisoSdaTxEnable=true, ScbMode=2, ScbModeHw=1, ScbMosiSclRxEnable=true, ScbRxWakeIrqEnable=false, ScbSclkEnable=false, ScbSs0Enable=false, ScbSs1Enable=false, ScbSs2Enable=false, ScbSs3Enable=false, ScbSymbolVisibility=0, SpiBitRate=1000, SpiBitsOrder=1, SpiByteModeEnable=false, SpiClkFreqDes=13000, SpiClockFromTerm=false, SpiFreeRunningSclk=false, SpiInterruptMode=0, SpiIntrMasterSpiDone=false, SpiIntrRxFull=false, SpiIntrRxNotEmpty=false, SpiIntrRxOverflow=false, SpiIntrRxTrigger=false, SpiIntrRxUnderflow=false, SpiIntrSlaveBusError=false, SpiIntrTxEmpty=false, SpiIntrTxNotFull=false, SpiIntrTxOverflow=false, SpiIntrTxTrigger=false, SpiIntrTxUnderflow=false, SpiLateMisoSampleEnable=false, SpiManualOversampleControl=true, SpiMasterMode=true, SpiMedianFilterEnable=false, SpimMisoTermEnable=false, SpimMosiTermEnable=false, SpiMode=1, SpimSclkTermEnable=false, SpimSs0TermEnable=false, SpimSs1TermEnable=false, SpimSs2TermEnable=false, SpimSs3TermEnable=false, SpiNumberOfRxDataBits=8, SpiNumberOfSelectLines=0, SpiNumberOfTxDataBits=8, SpiOvsFactor=13, SpiRemoveMiso=false, SpiRemoveMosi=false, SpiRemoveSclk=false, SpiRxBufferSize=8, SpiRxIntrMask=0, SpiRxOutputEnable=false, SpiRxTriggerLevel=7, SpiSclkMode=0, SpiSlaveMode=false, SpiSmartioEnable=false, SpisMisoTermEnable=false, SpisMosiTermEnable=false, SpiSs0Polarity=0, SpiSs1Polarity=0, SpiSs2Polarity=0, SpiSs3Polarity=0, SpisSclkTermEnable=false, SpisSsTermEnable=false, SpiSubMode=0, SpiTransferSeparation=1, SpiTxBufferSize=8, SpiTxIntrMask=0, SpiTxOutputEnable=false, SpiTxTriggerLevel=0, SpiWakeEnable=false, TriggerOutputEnable=false, TxTriggerOutputEnable=false, UartByteModeEnable=false, UartClkFreqDes=1382.4, UartClockFromTerm=false, UartCtsEnable=false, UartCtsPolarity=0, UartCtsTermEnable=false, UartDataRate=115200, UartDirection=3, UartDropOnFrameErr=false, UartDropOnParityErr=false, UartInterruptMode=0, UartIntrRxBreakDetected=false, UartIntrRxFrameErr=false, UartIntrRxFull=false, UartIntrRxNotEmpty=false, UartIntrRxOverflow=false, UartIntrRxParityErr=false, UartIntrRxTrigger=false, UartIntrRxUnderflow=false, UartIntrTxEmpty=false, UartIntrTxNotFull=false, UartIntrTxOverflow=false, UartIntrTxTrigger=false, UartIntrTxUartDone=false, UartIntrTxUartLostArb=false, UartIntrTxUartNack=false, UartIntrTxUnderflow=false, UartIrdaLowPower=false, UartIrdaPolarity=0, UartMedianFilterEnable=false, UartMpEnable=false, UartMpRxAcceptAddress=false, UartMpRxAddress=2, UartMpRxAddressMask=255, UartNumberOfDataBits=8, UartNumberOfStopBits=2, UartOvsFactor=12, UartParityType=2, UartRtsEnable=false, UartRtsPolarity=0, UartRtsTermEnable=false, UartRtsTriggerLevel=4, UartRxBreakWidth=11, UartRxBufferSize=8, UartRxEnable=false, UartRxIntrMask=0, UartRxOutputEnable=false, UartRxTermEnable=false, UartRxTriggerLevel=7, UartRxTxTermEnable=false, UartSmartioEnable=false, UartSmCardRetryOnNack=false, UartSubMode=0, UartTxBufferSize=8, UartTxEnable=false, UartTxIntrMask=0, UartTxOutputEnable=false, UartTxTermEnable=false, UartTxTriggerLevel=0, UartWakeEnable=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SCB_P4_v4_0, CY_CONFIG_TITLE=GLCD_SPIM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=GLCD_SPIM, CY_INSTANCE_SHORT_NAME=GLCD_SPIM, CY_MAJOR_VERSION=4, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=GLCD_SPIM, )
...
module top ;
	...
	wire [0:0] tmpOE__U_ADC_net;
	wire [0:0] tmpFB_0__U_ADC_net;
	wire [0:0] tmpIO_0__U_ADC_net;
	wire [0:0] tmpINTERRUPT_0__U_ADC_net;
	electrical [0:0] tmpSIOVREF__U_ADC_net;
	...
	cy_psoc3_pins_v1_10
		...
		U_ADC
		 (.oe(tmpOE__U_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__U_ADC_net[0:0]}),
		  .analog({Net_363}),
		  .io({tmpIO_0__U_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__U_ADC_net),
		  .interrupt({tmpINTERRUPT_0__U_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__U_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v4_0_2 GLCD_SPIM (
        .cts_in(1'b0),
        .rts_out(Net_185),
        .interrupt(Net_186),
        .clock(1'b0),
	...
	cy_clock_v1_0
		#(.id("cf24e4ed-6d79-4b42-8659-bcaed8d021a2"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__N_ADC_net;
	wire [0:0] tmpFB_0__N_ADC_net;
	wire [0:0] tmpIO_0__N_ADC_net;
	wire [0:0] tmpINTERRUPT_0__N_ADC_net;
	electrical [0:0] tmpSIOVREF__N_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("8cfd5f0e-4f74-4dc2-801f-322ad78f6abd"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		N_ADC
		 (.oe(tmpOE__N_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__N_ADC_net[0:0]}),
		  .analog({Net_362}),
		  .io({tmpIO_0__N_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__N_ADC_net),
		  .interrupt({tmpINTERRUPT_0__N_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__N_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GLCD_PSB_net;
	wire [0:0] tmpFB_0__GLCD_PSB_net;
	wire [0:0] tmpIO_0__GLCD_PSB_net;
	wire [0:0] tmpINTERRUPT_0__GLCD_PSB_net;
	electrical [0:0] tmpSIOVREF__GLCD_PSB_net;

	cy_psoc3_pins_v1_10
		#(.id("82bb7bfe-51a2-4cc7-b5e8-43627bd00335"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GLCD_PSB
		 (.oe(tmpOE__GLCD_PSB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GLCD_PSB_net[0:0]}),
		  .io({tmpIO_0__GLCD_PSB_net[0:0]}),
		  .siovref(tmpSIOVREF__GLCD_PSB_net),
		  .interrupt({tmpINTERRUPT_0__GLCD_PSB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GLCD_PSB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GLCD_CS_net;
	wire [0:0] tmpFB_0__GLCD_CS_net;
	wire [0:0] tmpIO_0__GLCD_CS_net;
	wire [0:0] tmpINTERRUPT_0__GLCD_CS_net;
	electrical [0:0] tmpSIOVREF__GLCD_CS_net;

	cy_psoc3_pins_v1_10
		#(.id("578ae41b-1a9e-41d7-9f46-df3fbe3c70b3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GLCD_CS
		 (.oe(tmpOE__GLCD_CS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GLCD_CS_net[0:0]}),
		  .io({tmpIO_0__GLCD_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__GLCD_CS_net),
		  .interrupt({tmpINTERRUPT_0__GLCD_CS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GLCD_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GLCD_RST_net;
	wire [0:0] tmpFB_0__GLCD_RST_net;
	wire [0:0] tmpIO_0__GLCD_RST_net;
	wire [0:0] tmpINTERRUPT_0__GLCD_RST_net;
	electrical [0:0] tmpSIOVREF__GLCD_RST_net;

	cy_psoc3_pins_v1_10
		#(.id("55de3239-9b7a-4c59-bb69-8c7c05226fc4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GLCD_RST
		 (.oe(tmpOE__GLCD_RST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GLCD_RST_net[0:0]}),
		  .io({tmpIO_0__GLCD_RST_net[0:0]}),
		  .siovref(tmpSIOVREF__GLCD_RST_net),
		  .interrupt({tmpINTERRUPT_0__GLCD_RST_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GLCD_RST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__V_ADC_net;
	wire [0:0] tmpFB_0__V_ADC_net;
	wire [0:0] tmpIO_0__V_ADC_net;
	wire [0:0] tmpINTERRUPT_0__V_ADC_net;
	electrical [0:0] tmpSIOVREF__V_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("c07c37ae-8295-4bee-87fd-d8a9711d7d2c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		V_ADC
		 (.oe(tmpOE__V_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_ADC_net[0:0]}),
		  .analog({Net_257}),
		  .io({tmpIO_0__V_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__V_ADC_net),
		  .interrupt({tmpINTERRUPT_0__V_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__W_ADC_net;
	wire [0:0] tmpFB_0__W_ADC_net;
	wire [0:0] tmpIO_0__W_ADC_net;
	wire [0:0] tmpINTERRUPT_0__W_ADC_net;
	electrical [0:0] tmpSIOVREF__W_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("f7f09334-fac9-4d91-931a-1b06229a63db"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		W_ADC
		 (.oe(tmpOE__W_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__W_ADC_net[0:0]}),
		  .analog({Net_406}),
		  .io({tmpIO_0__W_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__W_ADC_net),
		  .interrupt({tmpINTERRUPT_0__W_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__W_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MUX_A_net;
	wire [0:0] tmpFB_0__MUX_A_net;
	wire [0:0] tmpIO_0__MUX_A_net;
	wire [0:0] tmpINTERRUPT_0__MUX_A_net;
	electrical [0:0] tmpSIOVREF__MUX_A_net;

	cy_psoc3_pins_v1_10
		#(.id("fd824868-3193-4b03-94d9-6f05d89d0ebf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MUX_A
		 (.oe(tmpOE__MUX_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MUX_A_net[0:0]}),
		  .io({tmpIO_0__MUX_A_net[0:0]}),
		  .siovref(tmpSIOVREF__MUX_A_net),
		  .interrupt({tmpINTERRUPT_0__MUX_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MUX_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MUX_B_net;
	wire [0:0] tmpFB_0__MUX_B_net;
	wire [0:0] tmpIO_0__MUX_B_net;
	wire [0:0] tmpINTERRUPT_0__MUX_B_net;
	electrical [0:0] tmpSIOVREF__MUX_B_net;

	cy_psoc3_pins_v1_10
		#(.id("68c3eab3-f232-48d6-8b70-39eb0e86cc7b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MUX_B
		 (.oe(tmpOE__MUX_B_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MUX_B_net[0:0]}),
		  .io({tmpIO_0__MUX_B_net[0:0]}),
		  .siovref(tmpSIOVREF__MUX_B_net),
		  .interrupt({tmpINTERRUPT_0__MUX_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MUX_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MUX_C_net;
	wire [0:0] tmpFB_0__MUX_C_net;
	wire [0:0] tmpIO_0__MUX_C_net;
	wire [0:0] tmpINTERRUPT_0__MUX_C_net;
	electrical [0:0] tmpSIOVREF__MUX_C_net;
	...
	cy_psoc3_pins_v1_10
		...
		MUX_C
		 (.oe(tmpOE__MUX_C_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MUX_C_net[0:0]}),
		  .io({tmpIO_0__MUX_C_net[0:0]}),
		  .siovref(tmpSIOVREF__MUX_C_net),
		  .interrupt({tmpINTERRUPT_0__MUX_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MUX_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__X1_ADC_net;
	wire [0:0] tmpFB_0__X1_ADC_net;
	wire [0:0] tmpIO_0__X1_ADC_net;
	wire [0:0] tmpINTERRUPT_0__X1_ADC_net;
	electrical [0:0] tmpSIOVREF__X1_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("e649b3d2-1b83-4711-b7c5-705ba944a18f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		X1_ADC
		 (.oe(tmpOE__X1_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__X1_ADC_net[0:0]}),
		  .analog({Net_425}),
		  .io({tmpIO_0__X1_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__X1_ADC_net),
		  .interrupt({tmpINTERRUPT_0__X1_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__X1_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__L3_ADC_net;
	wire [0:0] tmpFB_0__L3_ADC_net;
	wire [0:0] tmpIO_0__L3_ADC_net;
	wire [0:0] tmpINTERRUPT_0__L3_ADC_net;
	electrical [0:0] tmpSIOVREF__L3_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("fb6aa3a7-4eca-4c73-a1a3-a1f81195af26"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		L3_ADC
		 (.oe(tmpOE__L3_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__L3_ADC_net[0:0]}),
		  .analog({Net_427}),
		  .io({tmpIO_0__L3_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__L3_ADC_net),
		  .interrupt({tmpINTERRUPT_0__L3_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__L3_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NL_ADC_net;
	wire [0:0] tmpFB_0__NL_ADC_net;
	wire [0:0] tmpIO_0__NL_ADC_net;
	wire [0:0] tmpINTERRUPT_0__NL_ADC_net;
	electrical [0:0] tmpSIOVREF__NL_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("50400a00-704b-400d-abce-4ee26f96e3a3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		NL_ADC
		 (.oe(tmpOE__NL_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NL_ADC_net[0:0]}),
		  .analog({Net_428}),
		  .io({tmpIO_0__NL_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__NL_ADC_net),
		  .interrupt({tmpINTERRUPT_0__NL_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NL_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__I3_ADC_net;
	wire [0:0] tmpFB_0__I3_ADC_net;
	wire [0:0] tmpIO_0__I3_ADC_net;
	wire [0:0] tmpINTERRUPT_0__I3_ADC_net;
	electrical [0:0] tmpSIOVREF__I3_ADC_net;

	cy_psoc3_pins_v1_10
		#(.id("6f348a2c-f979-41dc-bd51-206ced3bcd92"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		I3_ADC
		 (.oe(tmpOE__I3_ADC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__I3_ADC_net[0:0]}),
		  .analog({Net_443}),
		  .io({tmpIO_0__I3_ADC_net[0:0]}),
		  .siovref(tmpSIOVREF__I3_ADC_net),
		  .interrupt({tmpINTERRUPT_0__I3_ADC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__I3_ADC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
